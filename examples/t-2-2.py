...
class Main(object):
    def __init__(self):
        self.conn = pytds.connect(dsn='127.0.0.1', user=username, password=userpass, database='testing')
    ...
    def bug(self):
        ...
        sqls = (
            ...
            ("INSERT INTO #sqlvariant_test values( %s, %s)", 'decimal(8,2)', 'CAST(1.1 as decimal(8,2))'),
